...
function calcular() {
    ...
    if (isNaN(imc)) {
        ...
        if (imc < 0) {
            ...
            document.getElementById("mensaje").innerHTML = "Usted se encuentra <br> en el rango de delgadez.";
            document.getElementById("resultado").innerHTML = "Su IMC es" + " " + imc.toFixed(2);
        } else if (imc > 18.5 && imc <= 25) {
            document.getElementById("mensaje").innerHTML = "Usted se encuentra <br> en el rango de peso normal.";
            document.getElementById("resultado").innerHTML = "Su IMC es" + " " + imc.toFixed(2);
        } else if (imc > 25 && imc <= 26) {
            document.getElementById("mensaje").innerHTML = "Usted se encuentra <br> en el rango de sobrepeso.";
            document.getElementById("resultado").innerHTML = "Su IMC es" + " " + imc.toFixed(2);
        } else if (imc > 25 && imc <= 31.5) {
            document.getElementById("mensaje").innerHTML = "Usted se encuentra <br> en el rango de preobesidad.";
            document.getElementById("resultado").innerHTML = "Su IMC es" + " " + imc.toFixed(2);
        } else if (imc > 31.5 && imc <= 40) {
            document.getElementById("mensaje").innerHTML = "Usted se encuentra <br> en el rango de obesidad.";
            document.getElementById("resultado").innerHTML = "Su IMC es" + " " + imc.toFixed(2);
        } else if (imc > 40 && imc <= 65) {
            document.getElementById("mensaje").innerHTML = "Usted se encuentra <br> en el rango de hiperobesidad.";
            document.getElementById("resultado").innerHTML = "Su IMC es" + " " + imc.toFixed(2);
        } else {
            document.getElementById("mensaje").innerHTML = "Por favor, revisa los valores ingresados";
            document.getElementById("resultado").innerHTML = "";
